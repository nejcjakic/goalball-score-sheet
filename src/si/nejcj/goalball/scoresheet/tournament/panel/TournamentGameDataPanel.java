        ...
        .addGroup(groupLayout.createSequentialGroup()
          ...
          .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
            ...
            .addGroup(groupLayout.createSequentialGroup()
              ...
              .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                .addGroup(groupLayout.createSequentialGroup()
                  .addComponent(scorerCB, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
                  .addPreferredGap(ComponentPlacement.UNRELATED)
                  .addComponent(timerLBL))
                .addGroup(groupLayout.createSequentialGroup()
                  .addComponent(referee1cb, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
                  .addPreferredGap(ComponentPlacement.UNRELATED)
                  .addComponent(referee2LBL))
                .addGroup(groupLayout.createSequentialGroup()
                  .addComponent(goalJudge1CB, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
                  .addPreferredGap(ComponentPlacement.UNRELATED)
              ...
              .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                .addGroup(groupLayout.createSequentialGroup()
                  .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                    .addComponent(referee2cb, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
                    .addComponent(timerCB, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE))
                  .addPreferredGap(ComponentPlacement.UNRELATED)
                  .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                    .addComponent(backupTimerLBL)
                    .addComponent(tenSeconds1LBL)))
                .addGroup(groupLayout.createSequentialGroup()
                  .addComponent(goalJudge2CB, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
                  .addPreferredGap(ComponentPlacement.UNRELATED)
              ...
              .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
                ...
                .addComponent(tenSeconds1CB, 0, 90, Short.MAX_VALUE))
              .addPreferredGap(ComponentPlacement.UNRELATED)
              .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
              ...
              .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
                ...
                .addComponent(tenSeconds2CB, 0, 90, Short.MAX_VALUE))
