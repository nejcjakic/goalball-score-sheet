...
public class PdfFieldConverter {
  public static Map<String, String> createGameInformationMap(
    ...
    String gameDate = Constants.DEFAULT_DATE_FORMAT.format(tournamentGame
        .getGameDate());
    ...
    String scorer = tournamentGame.getScorer() == null ? null : tournamentGame
        .getScorer().getFullName();
    gameInformationMap.put(FIELD_SCORER, scorer);
    String timer = tournamentGame.getTimer() == null ? null : tournamentGame
        .getTimer().getFullName();
    ...
    for (TournamentPlayer player : teamAPlayers) {
      if (loopCount == 1) {
        ...
        gameInformationMap.put(FIELD_TEAM_A_PLAYER_3_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_A_PLAYER_4_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_A_PLAYER_5_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_A_PLAYER_6_NUMBER, player
            .getPlayerNumber().toString());
    ...
    for (TournamentPlayer player : teamBPlayers) {
      if (loopCount == 1) {
        gameInformationMap.put(FIELD_TEAM_B_PLAYER_1_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_B_PLAYER_2_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_B_PLAYER_3_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_B_PLAYER_4_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_B_PLAYER_5_NUMBER, player
            .getPlayerNumber().toString());
        ...
        gameInformationMap.put(FIELD_TEAM_B_PLAYER_6_NUMBER, player
            .getPlayerNumber().toString());
